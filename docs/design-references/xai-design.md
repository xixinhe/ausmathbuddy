...
See `docs/design-references/xai-design-system.html` for a working implementation of this spec, and `tokens/xai-tokens.css` for the token values as portable CSS custom properties.
